...
const SITE = {"name":"Fachowe Strony","site":"https://fachowe-strony.pl","base":"/","trailingSlash":false,"googleSiteVerificationId":"orcPxI47GSa-cRvY11tUe6iGg2IO_RPvnA1q95iEM3M","local-dir":"./dist/"};
                    const I18N = {"language":"pl","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"Fachowe Strony Kraków","template":"%s — Fachowe Strony Kraków"},"description":"🚀 Suitable for Startups, Small Business, Sass Websites, Professional Portfolios, Marketing Websites, Landing Pages & Blogs.","robots":{"index":true,"follow":true},"openGraph":{"type":"website","site_name":"Strony internetowe Kraków","images":[{"url":"~/assets/images/default.png","width":1200,"height":628}]},"twitter":{"handle":"@onwidget","site":"@onwidget","cardType":"summary_large_image"}};
...
export { APP_BLOG as A, BLOG_BASE as B, CATEGORY_BASE as C, DEFAULT_HASH_PROPS as D, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, VALID_INPUT_FORMATS as V, getPermalink as a, getFormattedDate as b, getBlogPermalink as c, getCanonical as d, cleanSlug as e, getAsset as f, getHomePermalink as g, VALID_SUPPORTED_FORMATS as h, DEFAULT_OUTPUT_FORMAT as i, trimSlash as t };
