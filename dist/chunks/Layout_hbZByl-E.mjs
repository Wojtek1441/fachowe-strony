...
import 'kleur/colors';
/* empty css                                   */
import { f as getAsset, U as UI, d as getCanonical, S as SITE, I as I18N, M as METADATA } from './consts_mI-NZtJF.mjs';
import 'clsx';
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { g as getImage } from './_astro_assets_C2WIL4s6.mjs';
...
}, "/workspaces/fachowe-strony/src/components/common/CommonMeta.astro", undefined);
...
const favIconSvg = new Proxy({"src":"/_astro/favicon.vp_fBu0c.svg","width":128,"height":128,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/fachowe-strony/src/assets/favicons/favicon.svg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/workspaces/fachowe-strony/src/assets/favicons/favicon.svg");
							return target[name];
						}
					});
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DHIlG7dp.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/fachowe-strony/src/assets/favicons/apple-touch-icon.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/workspaces/fachowe-strony/src/assets/favicons/apple-touch-icon.png");
							return target[name];
						}
					});
...
}, "/workspaces/fachowe-strony/src/components/Favicons.astro", undefined);
...
}, "/workspaces/fachowe-strony/src/components/CustomStyles.astro", undefined);
...
}, "/workspaces/fachowe-strony/src/components/common/ApplyColorMode.astro", undefined);
...
}, "/workspaces/fachowe-strony/node_modules/@astrolib/seo/src/AstroSeo.astro", undefined);
...
const load = async function() {
  ...
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./app-store_CMGigae_.mjs'),"/src/assets/images/default.png": () => import('./default_Chv7Jc_h.mjs'),"/src/assets/images/development-web-design-4536630.png": () => import('./development-web-design-4536630_DjeTjNWv.mjs'),"/src/assets/images/download.jpg": () => import('./download_BEgfGkaF.mjs'),"/src/assets/images/google-play.png": () => import('./google-play_CQ1I_dpe.mjs'),"/src/assets/images/hero-image.png": () => import('./hero-image_CA54MjO0.mjs'),"/src/assets/images/images.jpg": () => import('./images_DMOdC8m4.mjs'),"/src/assets/images/professional-web-design-social-ink-professional-web-design-png-1000_813.png": () => import('./professional-web-design-social-ink-professional-web-design-png-1000_813_BO0XfBti.mjs')});
  } catch (error) {
  }
  return images;
};
...
}, "/workspaces/fachowe-strony/src/components/common/Metadata.astro", undefined);
...
}, "/workspaces/fachowe-strony/src/components/common/SiteVerification.astro", undefined);
...
}, "/workspaces/fachowe-strony/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", undefined);

const $$Analytics = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${null}`;
}, "/workspaces/fachowe-strony/src/components/common/Analytics.astro", undefined);
...
}, "/workspaces/fachowe-strony/src/components/common/BasicScripts.astro", undefined);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/workspaces/fachowe-strony/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/workspaces/fachowe-strony/node_modules/astro/components/ClientRouter.astro", undefined);
...
}, "/workspaces/fachowe-strony/src/layouts/Layout.astro", undefined);
