...
import { V as VALID_INPUT_FORMATS, A as APP_BLOG, B as BLOG_BASE, C as CATEGORY_BASE, T as TAG_BASE, e as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash } from './consts_9XgGQQB-.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BOzuB5It.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BL-JgJbX.mjs');
