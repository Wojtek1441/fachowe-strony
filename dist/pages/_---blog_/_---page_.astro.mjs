...
import { e as getStaticPathsBlogList, h as blogListRobots } from '../../chunks/blog_DDikExH7.mjs';
...
` })} ${renderComponent($$result2, "BlogList", $$List, { "posts": page.data })} ${renderComponent($$result2, "Pagination", $$Pagination, { "prevUrl": page.url.prev, "nextUrl": page.url.next })} <!--
    ...
    --> </section> ` })}`;
}, "/workspaces/fachowe-strony/src/pages/[...blog]/[...page].astro", undefined);

const $$file = "/workspaces/fachowe-strony/src/pages/[...blog]/[...page].astro";
const $$url = "/[...blog]/[...page]";
